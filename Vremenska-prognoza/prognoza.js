$(document).ready(function() {
  $('#send').click(function(e) {
    ...
    if (grad !== '') {
      $.ajax({
        type: 'GET',
        url: 'https://api.openweathermap.org/data/2.5/forecast?q=' + grad + '&appid=88afa186093f064140a073c72afb239c&units=metric',
        dataType: 'jsonp',
...
function main(data)
{
  ...
  for (var i=0; i<duzinaNiza;i++)
  {
    ...
    if(danas!=danasPrognoza)//Uslov da ignorise danasnji dan
    {
      ...
      if(danasPrognoza==danas+3) treciDanVrijeme.push(niz[i]);
  ...
  function tabele(dan)
  {
    ...
    for (var i=0;i<duzina;i++)
    {
      ...
      satSardzaj.append(sat);
      $(redPodataka).append(satSardzaj);
      ////////////////
